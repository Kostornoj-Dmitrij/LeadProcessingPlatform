...
/// <summary>
/// Avro-событие, публикуемое после выполнения компенсации скоринга лида
/// </summary>
public class LeadScoringCompensated : IntegrationEventAvro
{
    private static readonly Schema _schema = Schema.Parse(@"{
        ""type"": ""record"",
        ""name"": ""LeadScoringCompensated"",
        ""namespace"": ""AvroSchemas.Messages.ScoringEvents"",
        ""fields"": [
