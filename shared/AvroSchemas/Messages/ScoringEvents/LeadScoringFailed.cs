...
/// <summary>
/// Avro-событие, публикуемое при ошибке выполнения скоринга лида
/// </summary>
public class LeadScoringFailed : IntegrationEventAvro
{
    private static readonly Schema _schema = Schema.Parse(@"{
        ""type"": ""record"",
        ""name"": ""LeadScoringFailed"",
        ""namespace"": ""AvroSchemas.Messages.ScoringEvents"",
        ""fields"": [
    ...
    public override void Put(int fieldPos, object fieldValue)
    {
        switch (fieldPos)
        {
            ...
            case 6: RetryCount = Convert.ToInt32(fieldValue); break;
