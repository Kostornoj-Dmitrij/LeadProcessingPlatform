...
/// <summary>
/// Avro-событие, публикуемое при успешном распределении лида
/// </summary>
public class DistributionSucceeded : IntegrationEventAvro
{
    ...
    public override void Put(int fieldPos, object fieldValue)
    {
        switch (fieldPos)
        {
            ...
            case 5: Target = fieldValue.ToString() ?? string.Empty; break;
            case 6: DistributedAt = Convert.ToInt64(fieldValue); break;
