...
/// <summary>
/// Тесты для LeadDistributionFailedFinalEventHandler
/// </summary>
[Category("Application")]
public class LeadDistributionFailedFinalEventHandlerTests : DatabaseTestBase
{
    private const string NotificationType = "LeadDistributionFailedFinal";
    private const string AnalyticsEmail = "analytics@example.com";

    private Mock<INotificationSender> _notificationSenderMock = null!;
    private Mock<ILogger<LeadDistributionFailedFinalEventHandler>> _loggerMock = null!;
    private LeadDistributionFailedFinalEventHandler _sut = null!;
    ...
    public void Setup()
    {
        ...
        _loggerMock = new Mock<ILogger<LeadDistributionFailedFinalEventHandler>>();
        _sut = new LeadDistributionFailedFinalEventHandler(
    ...
    public async Task Handle_WhenNotificationSucceeds_ShouldSaveNotificationAndMarkAsSent(
        [WithValidLeadDistributionFailedFinalEvent] LeadDistributionFailedFinal @event,
        string subject,
        string body)
    {
