...
{
    private const string NotificationType = "LeadDistributionFailed";
    ...
    public void Setup()
    {
        ...
        _sut = new LeadDistributionFailedEventHandler(
    ...
    [Test, AutoData]
    public async Task Handle_ShouldPassReasonInVariables(
        [WithValidLeadDistributionFailedEvent] LeadDistributionFailed @event,
