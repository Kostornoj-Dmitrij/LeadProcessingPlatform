...
/// <summary>
/// Кастомизация для LeadCreatedIntegrationEvent
/// </summary>
public class LeadCreatedEventCustomization : ICustomization
{
    public void Customize(IFixture fixture)
    {
        fixture.Customize<LeadCreatedIntegrationEvent>(composer => composer
            .With(e => e.LeadId, fixture.Create<Guid>())
            .With(e => e.Source, "web_form")
            .With(e =>
                e.CompanyName, fixture.Create<string>().Substring(0, Math.Min(50, fixture.Create<string>().Length)))
